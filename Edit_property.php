...
<html>
    ...
    <body onload="breadcrumb()">
        ...
        <!--breadcrumb-->
        <ul class="breadcrumb">
            <li><a href="../proj/index.html">Home</a></li>
                ...
                <form name="form1" id="formID" action="app.php" method="POST" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="formrow">
                            ...
                            <input type="text" id="propertyname" name="name" value=" <?php echo $info['name'] ?> " accesskey="n">
                        </div>
                        ...
                        <div class="formrow">
                            ...
                            <input type="number" id="room" name="room" accesskey="d" value="<?php echo $info['rooms'] ?>">
                        </div>

                        <div class="formrow">
                            <label for="Rent">Rent:</label>
                            <input type="number" id="rent" name="rent" accesskey="i" value=<?php echo $info['rent_cost'] ?>>
                        </div>

                        <div class="formrow">
                            <label for="location"> Location:</label>
                            <input type="text" id="location" name="location" value=" <?php echo $info['location'] ?> " accesskey="j">
                        </div>
                        <div class="formrow">
                            <label for="tenants">Max number of tenants:</label>
                            <input type="number" id="tenants" name="tenants" accesskey="i" value=<?php echo $info['max_tenants'] ?>>
                        </div>
                        <div class="formrow">
                        ...
                        <input hidden name="prop_id" value="<?php echo $info['id']?>">
                        <input class="b" type="submit" name="updateProperty" value="Save" accesskey="s">
                        <br /><br /><br />
                    </fieldset>
                </form>
